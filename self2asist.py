...
acil = PRANKBOTS.LINE() 
acil.login(token="EsXJ0PZ3Pjdw0oF1Yvv8.o5LtwTXkm5QfCDRaFGl4Ia.AVlYe/XZiNVjYQVFuZpoXLiuXkUSNTnjeWDrJq5ZKfo=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="EsDFcLgDn5FSMGiGQYU0.xdO2l15ERMxCs96PwiDIia.R3PCdTMDPNZMlJIYcjQRofM1gGca2BPqixjtGVp/mac=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="Esmc5LsOpOFDK9L8Wa38.bN5WrNyg5cB90AIgzQlCAa.PAyqm4b3+UZILatLdGPTeFb6F6YjUibXeo9MKfZhzhk=")
pb2.loginResult()
...
admsa = "u3b99535adc4a339a8571dac07e02f888"
